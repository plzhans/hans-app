...
### 개인정보처리방침 · 이용약관 — 없다. 만들어야 한다

스토어 등록 시 **공개 URL 입력이 필수**인데 지금 라우트에 아무것도 없다.
수집 항목 · 보관 기간 · 제3자 제공 · 위탁 · 파기 절차를 적는다.
실제 수집 주체는 [5 절](#5-개인정보-공시)에 실측해 두었다.
4 개 국어 서비스이므로 번역본도 필요한지 판단한다.
...
| 수집 주체 | 무엇을 | 신고 |
| --- | --- | --- |
| Google Analytics 4 (`G-E36S13YMV3`) | 사용 데이터 · 대략적 위치 | 필요 |
