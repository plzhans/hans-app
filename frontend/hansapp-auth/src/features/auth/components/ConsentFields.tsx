 ...
 * 더 받는 것으로 얻는 것이 없다. 2026-08-22 개정으로 **문서에서도 연령 조항을 뺐다** — 생년월일을
 * 받지 않아 확인할 수단이 없는데 "만 14세 미만은 가입할 수 없다" 고 적어 두면 지키지 못할 것을
 * 약속하는 셈이라, 연령으로 가입을 가르지 않기로 했다(게임처럼 연령 등급이 있는 서비스가 아니다).
 *
