...
/**
 * 라우트 정의. **라우터를 여기서 만들지 않는다.**
 *
 * 브라우저는 createBrowserRouter 로, 서버(워커)는 createStaticHandler 로 서로 다른 라우터를
 * 만들지만 **라우트 배열은 같아야 한다** — 다르면 서버가 그린 화면과 브라우저의 첫 렌더가
 * 어긋나 hydration 이 깨진다. 그래서 배열만 내보내고 라우터 생성은 진입점이 한다.
 */
