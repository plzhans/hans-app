...
export function userCommand(source: EnvSource): Command {
  ...
  addExamples(
    ...
    ['hansapi-cli user show --email me@example.com'],
  );
  ...
  addExamples(
    ...
    [
      'hansapi-cli user tier --email me@example.com --tier UNLIMITED',
      'hansapi-cli user tier --email me@example.com --tier BASIC',
    ],
  );
