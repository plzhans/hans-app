...
import { ConfigSource, findRootDir } from '@hansapp/common';
import {
...
export function i18nCommand(source: ConfigSource): Command {
  ...
  addExamples(
    ...
    [
      'hansapp-cli i18n export                          # en, ja 전부',
      'hansapp-cli i18n export --lang en --fields name  # 영문 병원명만',
      'hansapp-cli i18n export --limit 200              # 샘플 200건',
      'hansapp-cli i18n export --force                  # 번역이 채워진 파일도 덮어쓴다',
    ],
  );
