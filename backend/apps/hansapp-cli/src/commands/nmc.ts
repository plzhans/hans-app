...
export function nmcCommand(source: ConfigSource): Command {
  ...
  addExamples(
    ...
    [
      'hansapp-cli nmc hospital search --sido 서울특별시 --sigungu 종로구 --simple',
      'hansapp-cli nmc hospital search --subject D001 --day 1 --simple',
    ],
  );
  ...
  addExamples(
    ...
    [
      'hansapp-cli nmc hospital list --simple            # 로컬 DB',
      'hansapp-cli nmc hospital list --origin --simple   # 원본 API',
    ],
  );
  ...
  addExamples(
    ...
    ['hansapp-cli nmc baby list --sido 서울특별시 --simple'],
  );
  ...
  addExamples(
    ...
    [
      'hansapp-cli nmc code list -m H010 --simple',
      'hansapp-cli nmc code list --origin -n 3000 --simple',
    ],
  );
