...
import { HiraNmcMatchService } from '@hansapp/admin-application';
...
export function hiraNmcCommand(source: ConfigSource): Command {
  ...
  addExamples(
    ...
    [
      'hansapp-cli hira-nmc match',
      'hansapp-cli hira-nmc match --dry-run',
      'hansapp-cli hira-nmc match --recheck',
    ],
  );
