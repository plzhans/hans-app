...
/**
 * 제네릭 PageResponseDto<Item> 의 items 스키마를 Swagger 에 명시하는 헬퍼.
 * PageResponseDto 의 items 는 제네릭이라 자동으로 타입이 잡히지 않으므로,
 * 컨트롤러에서 @ApiPageResponse(ItemDto) 로 감싸 실제 항목 타입을 노출한다.
 */
