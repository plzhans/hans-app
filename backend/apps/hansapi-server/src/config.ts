import { createConfigSource } from '@hansapi/common';
import type { AppEnv, ConfigSource, DotenvLoader } from '@hansapi/common';

/**
 * 서버의 설정 접근자를 만든다. 계층형 .env(EnvSource) 위에 config/<환경>.yaml + 환경변수(__ 계층)를
