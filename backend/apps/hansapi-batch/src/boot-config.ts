...
import type { BuildInfo, ConfigSource } from '@hansapi/common';
 ...
 * 여기서 무거운 것을 import 하면 안 된다(@hansapi/common 은 js-yaml·lodash.merge 뿐이다).
 */
...
// 설정 접근자(ConfigSource). config/config.<환경>.yaml 위에 계층형 .env 를 얹어 경로 게터로 읽고,
