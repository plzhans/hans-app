...
export class TransportController {
  ...
  @ApiOperation({
    ...
    description:
      ...
      '다국어로 보여줄 때 쓴다.\n\n' +
      '**언어를 한꺼번에 다 내린다.** 다른 API 와 달리 `Accept-Language` 를 보지 않는다 — ' +
      '화면에 나온 역명을 **찾아 바꾸는** 용도라, 클라이언트가 통째로 받아 맵으로 들고 쓰기 ' +
      '때문이다. 언어를 바꿀 때 다시 받을 필요가 없다.\n\n' +
      ...
      '원본 갱신 주기가 길어(연 1~2회) 대부분의 재검증이 304 다.\n\n' +
