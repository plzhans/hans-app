 ...
 */
import type { BabyHospitalLocationResult } from './babyHospitalLocationResult';

export interface BabyHospitalLocationResponse {
  response?: BabyHospitalLocationResult;
}
