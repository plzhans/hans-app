// 이 계층이 공개 API 로 내보내는 오류 번호와, 자주 던지는 오류 클래스.
export * from './error';
// 모듈
...
export { SessionTrimService } from './session-trim.service';
...
// 앱 도메인 엔티티 타입(서버 컨트롤러 매핑용). 서버는 @hansapp/data 를 직접 의존하지 않는다.
export type { App, AppApiKey, AppClient } from '@hansapp/data';
