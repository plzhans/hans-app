 ...
 *
 * 커밋 메시지는 워크스페이스별이 아니라 레포 전체 공통이라, 이 검사는 backend/frontend 로
 * 위임하지 않고 루트에서 바로 건다. 규약 설명은 DEVELOP.md 의 "커밋 규약" 참고.
 */
export default {
  ...
  rules: {
     ...
     * 쓸 수 있는 타입.
     *
     * 기본 목록에서 `style` 을 뺐다 - 포매터로 서식만 고치는 자리가 `refactor` 와
     * 헷갈리기만 하고, 별도 타입일 이유가 없다.
     */
    'type-enum': [
      2,
      'always',
